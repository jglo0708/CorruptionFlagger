...
data.groupby(['tender_indicator_INTEGRITY_SINGLE_BID']).size().plot.bar()
plt.show()
...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, df):
        ...
        self.labels = [labels[label] for label in df['tender_indicator_INTEGRITY_SINGLE_BID']]
...
# texts = data['text'].values.tolist()[:10]
